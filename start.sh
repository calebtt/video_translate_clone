...
echo ""
MAX_UPLOAD_MB="${VTCLONE_MAX_UPLOAD_MB:-300}"
export VTCLONE_MAX_UPLOAD_MB="$MAX_UPLOAD_MB"
...
echo "  Max upload:   ${MAX_UPLOAD_MB} MB (VTCLONE_MAX_UPLOAD_MB)"
echo "  Health:       curl http://127.0.0.1:${API_PORT}/health"
echo "  RunPod proxy: https://<POD_ID>-${API_PORT}.proxy.runpod.net"
echo "  WebSocket:    wss://<POD_ID>-${API_PORT}.proxy.runpod.net/v1/ws"
echo "  Docs:         https://<POD_ID>-${API_PORT}.proxy.runpod.net/docs"
echo "  Rent:         GPU ≥16GB VRAM (24GB preferred), network volume ≥50GB"
echo "  Example job:"
